  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        {posts.map((post) => (
          <a key={post.frontmatter.slug} href={`/templates/executive-brief/${post.frontmatter.slug}`} className="block group bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">

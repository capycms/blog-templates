  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        {posts.map((post) => (
          <a key={post.frontmatter.slug} href={`/templates/indie-maker/${post.frontmatter.slug}`} className="block group bg-white rounded-lg border border-sky-200 p-6 hover:shadow-md transition-shadow">

...
export default function BlogLayout({ children, branding }: { children: React.ReactNode; branding?: Branding }) {
  const name = branding?.blogName ?? "One Column Light";
  return (
    <div className="bg-gray-50 text-gray-800 min-h-screen">
      <header className="border-b border-gray-100 bg-white/80 backdrop-blur">
        <div className="max-w-xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/" className="font-sans text-xl font-bold text-blue-500" style={branding?.accentColor ? { color: branding.accentColor } : undefined}>
      ...
      <footer className="border-t border-gray-100 mt-12">
        <div className="max-w-xl mx-auto px-6 py-6 text-center text-sm opacity-60">

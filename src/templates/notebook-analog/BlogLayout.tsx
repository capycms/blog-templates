...
export default function BlogLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="bg-yellow-50 text-yellow-900 min-h-screen">
      <header className="border-b border-yellow-300 bg-yellow-50/80 backdrop-blur">
      ...
      <footer className="border-t border-yellow-300 mt-12">

  ...
  return (
    <div>
      ...
      <div className="space-y-8">
        {posts.map((post) => (
          <a key={post.frontmatter.slug} href={`/templates/hacker-neon/${post.frontmatter.slug}`} className="block group">
            ...
            <div className="mt-2"><TagList tags={post.frontmatter.tags} variant="neon" /></div>
          </a>
        ))}
      </div>
    </div>

  ...
  return (
    <div>
      ...
      <div className="columns-1 md:columns-2 lg:columns-3 [column-gap:1.5rem]">
        {posts.map((post) => (
          <a key={post.frontmatter.slug} href={`/templates/split-visual/${post.frontmatter.slug}`} className="block break-inside-avoid mb-6 group bg-white rounded-lg border border-gray-300 overflow-hidden hover:shadow-md transition-shadow">

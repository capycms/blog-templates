  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        {posts.map((post) => (
          <a key={post.frontmatter.slug} href={`/templates/gradient-expressive/${post.frontmatter.slug}`} className="block group bg-white/80 rounded-lg border border-pink-200 p-6 hover:shadow-md transition-shadow">

...
export default function BlogLayout({ children, branding }: { children: React.ReactNode; branding?: Branding }) {
  const name = branding?.blogName ?? "Neon Glitch";
  return (
    <div className="bg-black text-fuchsia-300 min-h-screen">
      <header className="border-b border-fuchsia-700 bg-gray-950/80 backdrop-blur">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/" className="font-mono text-xl font-bold text-cyan-400" style={branding?.accentColor ? { color: branding.accentColor } : undefined}>

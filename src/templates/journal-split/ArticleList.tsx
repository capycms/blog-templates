  ...
  return (
    <div>
      ...
      <div className="space-y-8">
        {posts.map((post) => (
          <a key={post.frontmatter.slug} href={`/templates/journal-split/${post.frontmatter.slug}`} className="block group">
            <div className="flex items-start gap-4">
              ...
              {post.frontmatter.coverImage ? (
                <div className="hidden sm:block w-32 shrink-0 aspect-video bg-gray-200 overflow-hidden rounded border border-stone-200">

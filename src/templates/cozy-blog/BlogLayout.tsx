    ...
    <div className="bg-orange-50 text-orange-900 min-h-screen">
      ...
      <header className="border-b border-orange-200 bg-white/80 backdrop-blur">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/" className="font-serif text-xl font-bold text-orange-500">Cozy Blog</a>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8 flex gap-8">
        <div className="flex-1 min-w-0">{children}</div>
          <aside className="w-64 shrink-0 hidden lg:block">
            <div className="sticky top-8 bg-white border-orange-200 border rounded-lg p-4">
              <h3 className="font-serif font-bold mb-2">About</h3>
              <p className="text-sm opacity-70">Cozy Blog template</p>
            </div>
          </aside>
      </main>
      <footer className="border-t border-orange-200 mt-12">
        <div className="max-w-5xl mx-auto px-6 py-6 text-center text-sm opacity-60">
          &copy; 2026 Cozy Blog &mdash; Built with CapyCMS
        </div>
      </footer>
    </div>
  );
